...
USE car_agency;
INSERT INTO vehicles (brand, model, year, price, cor) VALUES
('Honda', 'Civic', 2005, 50000.00, 'Prata'),
('Toyota', 'Corolla', 2010, 42000.00, 'Preto'),
('Ford', 'Focus', 2014, 75000.00, 'Branco'),
('BMW', '320i', 2018, 120000.00, 'Azul');